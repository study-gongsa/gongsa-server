...
import study.gongsa.dto.GetMyQuestionResponse;
import study.gongsa.dto.GetStudyGroupInfoResponse;
...
public class QuestionController {
    ...
    public ResponseEntity findMyQuestion(HttpServletRequest request){
        ...
        DefaultResponse response = new DefaultResponse(new GetMyQuestionResponse(questionList));
